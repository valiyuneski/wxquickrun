...
DECLARE_EVENT_TYPE(wxEVT_COMMAND_LIST_ITEM_CHECKED, -1);
DECLARE_EVENT_TYPE(wxEVT_COMMAND_LIST_ITEM_UNCHECKED, -1);
...
protected:
	...
	// Stores the style flag, so that can be used for future processing
	// This does not pass the wxCLC_CHECK_WHEN_SELECTING to the windows control creation.
	bool m_bCheckWhenSelecting;
